...
# 导入数据
sheet_name = 'O_vs_Y'
pd_df = pd.read_excel('20241125.xlsx', sheet_name=sheet_name)
result = pd.DataFrame()
...
specific_names = ["ICAM-1"]  # Replace with the names you want to annotate specially
...
texts = [
    ax.text(
        ...
        color="black" if result.iloc[i][IDname] in specific_names else "black",  # Red for special names, black otherwise
