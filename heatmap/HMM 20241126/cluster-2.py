...
# 读取CSV文件
df = pd.read_excel('1126-2.xlsx', index_col=0)
...
ax.text(xposition+weight/2+width1/2, height+2, '2U-miR-8085', va='top', ha='center', fontsize=fontsize1, transform=ax.transData, rotation=0, fontweight='bold')
