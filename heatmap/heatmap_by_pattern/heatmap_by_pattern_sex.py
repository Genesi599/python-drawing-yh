...
@Author  : yh109
"""
from heatmap.heatmap_by_pattern.heatmap_by_pattern import draw_heatmap
...
def main():
    ...
    draw_pattern_pointplot(expr_df, df_pat, patterns, age_series, enrich_dict,
                           feature_meta, 'protein', 'Gene name', 'pearson_r', sample_meta=meta, figsize=(10, 16), base_fontsize=20, fc_cut=0, out_dir=base_path / 'figure',
                           split_up_down=True, is_up_regulation=True, enrich_show_n=4)
