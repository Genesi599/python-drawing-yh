...
# -*- coding: utf-8 -*-
"""
@File    : heatmap_by_pattern_sex.py
...
import os
from hybrid_chart.age_dotmap_by_pattern import draw_pattern_pointplot
...
def main():
    ...
    #              blank_rows=2, figsize=(10, 16), base_fontsize=20, fc_cut=0, out_dir=base_path / 'figure',
    #              split_up_down=True, is_up_regulation=True,)
    # draw_heatmap(expr_df, df_pat, patterns, condition_map, age_series, enrich_dict,
    #              feature_meta, 'protein', 'Gene name', 'pearson_r',
    #              blank_rows=2, figsize=(10, 16), base_fontsize=20, fc_cut=0, out_dir=base_path / 'figure',
    #              split_up_down=True, is_up_regulation=False,)

    draw_pattern_pointplot(expr_df, df_pat, patterns, age_series, enrich_dict,
                           feature_meta, 'COMP_ID', 'COMPOUND_Name', 'pearson_r', sample_meta=meta, figsize=(10, 16), base_fontsize=20, fc_cut=0, out_dir=base_path / 'figure',
